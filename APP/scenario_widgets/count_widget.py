...
class SimpleApp(QWidget, DynamicWidget):
    ...
    def prepare(self, recordDict:dict|None = None):
        ...
        self.widget.setGeometry(QRect(100, 70, 582, 225))
        ...
        self.lbl_address.setMinimumSize(QSize(50, 20))
        self.lbl_address.setMaximumSize(QSize(50, 20))
        ...
        self.checkBox_onlyFiles.setMinimumSize(QSize(0, 20))
        self.checkBox_onlyFiles.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_2.addWidget(self.checkBox_onlyFiles)
        ...
        self.checkBox_followSymlinks.setMinimumSize(QSize(0, 20))
        self.checkBox_followSymlinks.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_2.addWidget(self.checkBox_followSymlinks)
        ...
        self.lbl_conditions.setMinimumSize(QSize(0, 25))
        self.lbl_conditions.setMaximumSize(QSize(16777215, 25))
        ...
        self.lbl_extension.setMinimumSize(QSize(100, 20))
        ...
        self.horizontalLayout_8.addWidget(self.lbl_excludeNameStartswith)
        ...
        self.lineEdit_excludeNameStartswith.setMinimumSize(QSize(139, 25))
        ...
        self.horizontalLayout_8.addWidget(self.lineEdit_excludeNameStartswith)
        ...
        self.lbl_nameStartswith.setMinimumSize(QSize(100, 20))
        ...
        self.lineEdit_nameStartswith.setMinimumSize(QSize(140, 25))
        ...
        self.lineEdit_excludeNameContains.setMinimumSize(QSize(0, 25))
        ...
        self.lbl_nameContains.setMinimumSize(QSize(100, 20))
        ...
        self.lineEdit_nameContains.setMinimumSize(QSize(198, 25))
        self.lineEdit_nameContains.setMaximumSize(QSize(140, 25))
